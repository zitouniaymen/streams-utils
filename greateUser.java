...
public class GatingSpliterator<E> implements Spliterator<E> {
    ...
    public static <E> GatingSpliterator<E> of(Spliterator<E> spliterator, Predicate<? super E> gate111) {
        Objects.requireNonNull(spliterator);
        Objects.requireNonNull(gate111);

        return new GatingSpliterator<>(spliterator, gate111);
    }
